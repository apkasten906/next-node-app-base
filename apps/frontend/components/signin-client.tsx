...
export function SignInClient({ onGoogleSignIn, onGitHubSignIn }: SignInClientProps): JSX.Element {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-24">
      <div className="w-full max-w-md space-y-8">
        ...
        <p className="text-xs text-center text-gray-500">{t('auth:signIn.footer')}</p>
      </div>
    </div>
  );
}
