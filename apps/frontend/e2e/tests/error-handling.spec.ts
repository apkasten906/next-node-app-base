...
import { AuthHelpers, TestData } from '../helpers/test-helpers';
...
test.describe('Error Handling', () => {
  ...
  test('Handle partial bulk operation failures', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="toast-warning"]')).toContainText(
  ...
  test('Handle WebSocket connection errors', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="websocket-status"]')).toContainText(
