...
// set the environment variable `REUSE_EXISTING_SERVER=true` when launching
// the test explorer or your test run. By default we fall back to reusing
// the server locally (non-CI).

const backendUrl = 'http://localhost:3001/health';
const frontendUrl = 'http://localhost:3000';

// Simple synchronous decision: allow explicit override via env var, otherwise
// reuse locally when not running in CI.
